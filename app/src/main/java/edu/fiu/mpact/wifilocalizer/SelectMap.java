...
public class SelectMap extends Activity {
    ...
    String[] maps = {"Engineering 1st Floor", "Engineering 2nd Floor", "Engineering 3rd Floor"};
    // map titles
    Integer[] imageId = {R.drawable.ec_1, R.drawable.ec_2, R.drawable.ec_3,  // list of the maps
    };
