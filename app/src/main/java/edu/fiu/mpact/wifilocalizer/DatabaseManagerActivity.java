...
public class DatabaseManagerActivity extends Activity implements OnItemClickListener {
    ...
    //a static class to save cursor,table values etc which is used by functions to share data in
    // the program.
    ...
    //in the below line Change the text 'yourCustomSqlHelper' with your custom sqlitehelper class
    // name.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //in the below line Change the text 'yourCustomSqlHelper' with your custom sqlitehelper
        // class name
        dbm = new Database(DatabaseManagerActivity.this);
        ...
        //the main table layout where the content of the sql tables will be displayed when user
        // selects a table
        ...
        LinearLayout.LayoutParams secondrowlp = new LinearLayout.LayoutParams(LayoutParams
        ...
        customquerytext.setHint("Enter Your Query here and Click on Submit Query Button .Results " +
        ...
        //the text view at the bottom of the screen which displays error or success messages
        ...
        submitQuery.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Message2.getString(0).equalsIgnoreCase("Success")) {
                    ...
                    //if there is any error we displayed the error message at the bottom of the
                    // screen
        ...
        // a query which returns a cursor with the list of tables in the database.We use this
        // cursor to populate spinner in the first row
        ...
        ArrayAdapter<String> tablenamesadapter = new ArrayAdapter<String>(DatabaseManagerActivity
        ...
        select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                ...
                if (pos != 0) {
                    ...
                    //displaying the content of the table which is selected in the select_table
                    // spinner
                    ...
                    ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>
                            (getApplicationContext(), android.R.layout
                                    .simple_spinner_dropdown_item, spinnertablevalues);
                    spinnerArrayAdapter.setDropDownViewResource(android.R.layout
                            .simple_spinner_item);

                    // a array adapter which add values to the spinner which helps in user making
                    // changes to the table
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>
                            (DatabaseManagerActivity.this, android.R.layout.simple_spinner_item,
                                    spinnertablevalues) {
                    ...
                    //getting contents of the table which user selected from the select_table
                    // spinner
                    ArrayList<Cursor> alc2 = dbm.getData(Query2);
                    final Cursor c2 = alc2.get(0);
                    //saving cursor to the static indexinfo class which can be resued by the
                    // other functions
                    indexInfo.maincursor = c2;

                    // if the cursor returned form the database is not null we display the data
                    // in table layout
                    if (c2 != null) {
                        ...
                        //the spinnertable has the 3 items to drop , delete , add row to the
                        ...
                        spinnertable.setOnItemSelectedListener((new OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parentView, View
                                ...
                                ((TextView) parentView.getChildAt(0)).setTextColor(Color.rgb(0,
                                        0, 0));
                                //when user selects to drop the table the below code in if block
                                // will be executed
                                if (spinnertable.getSelectedItem().toString().equals("Drop this "
                                        + "table")) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            if (!isFinishing()) {
                                                ...
                                                new AlertDialog.Builder(DatabaseManagerActivity
                                                        .this).setTitle("Are you sure ?")
                                                        .setMessage("Pressing yes will remove " +
                                                        indexInfo.table_name + " table " +
                                                        "from database").setPositiveButton("yes",
                                                        new DialogInterface.OnClickListener() {
                                                    // when user confirms by clicking on
                                                    // yes we drop the table by executing
                                                    // drop table query
                                                    public void onClick(DialogInterface dialog,
                                                                        int which) {

                                                        String Query6 = "Drop table " + indexInfo
                                                                .table_name;
                                                        ArrayList<Cursor> aldropt = dbm.getData
                                                                (Query6);
                                                        Cursor tempc = aldropt.get(1);
                                                        tempc.moveToLast();
                                                        Log.d("Drop table Mesage", tempc
                                                                .getString(0));
                                                        if (tempc.getString(0).equalsIgnoreCase
                                                                ("Success")) {
                                                            tvmessage.setBackgroundColor(Color
                                                                    .parseColor("#2ecc71"));
                                                            tvmessage.setText(indexInfo
                                                                    .table_name + "Dropped " +
                                                                    "successfully");
                                                            refreshactivity();
                                                        } else {
                                                            //if there is any error we
                                                            // displayd the error message
                                                            // at the bottom of the screen
                                                            tvmessage.setBackgroundColor(Color
                                                                    .parseColor("#e74c3c"));
                                                            tvmessage.setText("Error:" + tempc
                                                                    .getString(0));
                                ...
                                if (spinnertable.getSelectedItem().toString().equals("Delete " +
                                        "this" + " table")) {    // an alert dialog to confirm
                                        // user selection
                                    runOnUiThread(new Runnable() {
                                        @Override
                                        public void run() {
                                            if (!isFinishing()) {
                                                ...
                                                new AlertDialog.Builder(DatabaseManagerActivity
                                                        .this).setTitle("Are you sure?")
                                                        .setMessage("Clicking on yes will delete " +
                                                        "all the contents of " +
                                                        indexInfo.table_name + " table " +
                                                        "from database").setPositiveButton("yes",
                                                        new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog,
                                                        ...
                                                        ArrayList<Cursor> aldeletet = dbm.getData
                                                                (Query7);
                                                        Cursor tempc = aldeletet.get(1);
                                                        tempc.moveToLast();
                                                        Log.d("Delete table Mesage", tempc
                                                                .getString(0));
                                                        if (tempc.getString(0).equalsIgnoreCase
                                                                ("Success")) {
                                                            tvmessage.setBackgroundColor(Color
                                ...
                                //when user selects to add row to the table the below code in if
                                // block will be executed
                                if (spinnertable.getSelectedItem().toString().equals("Add row to " +
                                        "" + "this table")) {
                                    //we create a layout which has textviews with column names of
                                    // the table and edittexts where
                                    //user can enter value which will be inserted into the datbase.
                                    final LinkedList<TextView> addnewrownames = new
                                            LinkedList<TextView>();
                                    final LinkedList<EditText> addnewrowvalues = new
                                            LinkedList<EditText>();
                                    final ScrollView addrowsv = new ScrollView
                                            (DatabaseManagerActivity.this);
                                    Cursor c4 = indexInfo.maincursor;
                                    if (indexInfo.isEmpty) {
                                        getcolumnnames();
                                        for (int i = 0; i < indexInfo.emptytablecolumnnames.size
                                                (); i++) {
                                    ...
                                    final RelativeLayout addnewlayout = new RelativeLayout
                                            (DatabaseManagerActivity.this);
                                    RelativeLayout.LayoutParams addnewparams = new RelativeLayout
                                            .LayoutParams(RelativeLayout.LayoutParams
                                            .WRAP_CONTENT, RelativeLayout.LayoutParams
                                            .WRAP_CONTENT);
                                    ...
                                    for (int i = 0; i < addnewrownames.size(); i++) {
                                        ...
                                        final LinearLayout ll = new LinearLayout
                                                (DatabaseManagerActivity.this);
                                        LinearLayout.LayoutParams tvl = new LinearLayout
                                                .LayoutParams(0, 100);
                                        tvl.weight = 1;
                                        ll.addView(tv, tvl);
                                        ll.addView(et, tvl);
                                        ...
                                        RelativeLayout.LayoutParams rll = new RelativeLayout
                                                .LayoutParams(RelativeLayout.LayoutParams
                                    ...
                                    //the above form layout which we have created above will be
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            if (!isFinishing()) {
                                                new AlertDialog.Builder(DatabaseManagerActivity
                                                        .this).setTitle("values").setCancelable
                                                        (false).setView(addrowsv)
                                                        .setPositiveButton("Add", new
                                                                DialogInterface.OnClickListener() {
                                                    // after entering values if user
                                                    // clicks on add we take the values
                                                    ...
                                                    public void onClick(DialogInterface dialog,
                                                        ...
                                                        //this is the insert query which
                                                        // has been generated
                                                        Log.d("Insert Query", Query4);
                                                        ArrayList<Cursor> altc = dbm.getData
                                                                (Query4);
                                                        ...
                                                        if (tempc.getString(0).equalsIgnoreCase
                                                            ...
                                                            tvmessage.setBackgroundColor(Color
                                                                    .parseColor("#2ecc71"));
                                                            tvmessage.setText("New Row " +
                                                                    "added succesfully to" +
                                                                    " " + indexInfo.table_name);
                                                            refreshTable(0);
                                                        } else {
                                                            tvmessage.setBackgroundColor(Color
                                                ...
                                                }).setNegativeButton("close", new DialogInterface
                                                        .OnClickListener() {
                                                    public void onClick(DialogInterface dialog,
                                                                        int which) {
                                                        spinnertable.setSelection(0);
                        ...
                        //display the first row of the table with column names of the table
                        ...
                        //after displaying columnnames in the first row  we display data in the
                        // remaining columns
                        //the below paginatetbale function will display the first 10 tuples of
                        // the tables
                        //the remaining tuples can be viewed by clicking on the next button
                        paginatetable(c2.getCount());

                    } else {
                        //if the cursor returned from the database is empty we show that table is
                        // empty
                        help.setVisibility(View.GONE);
                        tableLayout.removeAllViews();
                        getcolumnnames();
    ...
    public void updateDeletePopup(int row) {
        ...
        RelativeLayout.LayoutParams lay = new RelativeLayout.LayoutParams(RelativeLayout
        ...
        LinearLayout.LayoutParams paramcrudtext = new LinearLayout.LayoutParams(LinearLayout
        ...
        RelativeLayout.LayoutParams rlcrudparam = new RelativeLayout.LayoutParams(RelativeLayout
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (!isFinishing()) {
                    new AlertDialog.Builder(DatabaseManagerActivity.this).setTitle("values")
                            .setView(updaterowsv).setCancelable(false).setPositiveButton("Ok",
                            new DialogInterface.OnClickListener() {

                                //this code will be executed when user changes values of edit
                                // text or spinner and clicks on ok button
                                public void onClick(DialogInterface dialog, int which) {

                                    //get spinner value
                                    String spinner_value = crud_dropdown.getSelectedItem()
                                            .toString();
                                    ...
                                    if (spinner_value.equalsIgnoreCase("Delete this row")) {
                                        ...
                                        indexInfo.index = 10;
                                        String Query5 = "DELETE FROM " + indexInfo.table_name + "" +
                                                " WHERE ";
                                        ...
                                        if (tempc.getString(0).equalsIgnoreCase("Success")) {
                                            tvmessage.setBackgroundColor(Color.parseColor
                                                    ("#2ecc71"));
                                            tvmessage.setText("Row deleted from " + indexInfo
                                                    .table_name + " table");
                                            refreshTable(0);
                                        } else {
                                            tvmessage.setBackgroundColor(Color.parseColor
    ...
    public void refreshTable(int d) {
        ...
        if (c3 != null) {
            ...
            //after displaying column names in the first row  we display data in the remaining
            // columns
    ...
    public void paginatetable(final int number) {
        ...
        // when user clicks on the previous button update the table with the previous 10 tuples
        // from the database
        previous.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (indexInfo.currentpage == 1) {
                    Toast.makeText(getApplicationContext(), "This is the first page", Toast
                            .LENGTH_LONG).show();
                } else {
        ...
        // when user clicks on the next button update the table with the next 10 tuples from the
        // database
        next.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (indexInfo.currentpage >= indexInfo.numberofpages) {
                    Toast.makeText(getApplicationContext(), "This is the last page", Toast
                            .LENGTH_LONG).show();
                } else {
                    indexInfo.currentpage = indexInfo.currentpage + 1;
                    boolean decider = true;
